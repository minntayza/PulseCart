...
export default function Sidebar({ selectedCategory, onCategoryChange }: CategoryNavProps) {
  return (
    <div className="flex flex-col gap-6 mb-10 relative z-10">
      ...
      {/* Premium AI Banner */}
      <div className="relative overflow-hidden flex items-center gap-4 rounded-3xl border border-primary/15 bg-gradient-to-r from-primary-light/50 to-agent-light/50 px-6 py-5 shadow-sm backdrop-blur-md">
