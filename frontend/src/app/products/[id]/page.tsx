  ...
  return <main className="min-h-screen bg-background"><div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <section className="grid gap-10 lg:grid-cols-[1.15fr_.85fr]">
      ...
      <div className="lg:py-4">
        ...
        <div className="mt-7 flex items-end justify-between border-y border-border py-5"><div><p className="text-xs text-text-muted">Current price</p><p className="text-3xl font-black tracking-tight">{formatPrice(product.price)}</p></div><div className="text-right">{details.stock > 0 ? <p className="text-sm font-semibold text-success">In stock · {details.stock} available</p> : <p className="text-sm font-semibold text-danger">Out of stock</p>}</div></div>
